...
class cls_captcha
{
     ...
     * @var string  $folder
     */
    var $folder     = 'publc/images/captcha';
    ...
    var $themes_jpg = array(
        ...
        5 => array('captcha_bg4.jpg', 255, 255, 255),
    );
    ...
    var $themes_gif = array(
        ...
        5 => array('captcha_bg4.gif', 255, 255, 255),
    );
    ...
    {
    	// modified by huangyu:从cookie里取验证码
//        $given    = $this->encrypts_word(strtoupper($word));
		$word = strtoupper($word);
        $recorded = Yii::app()->sess->get('session_word');
...
//        return (preg_match("/$given/", $recorded));
    ...
    function record_word($word)
    {
        ...
        Yii::app()->sess->add('session_word',$word);
    }
