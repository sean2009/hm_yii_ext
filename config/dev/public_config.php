 ...
 * 项目地址
 */
define('DOMAIN_USER', 'http://user.ec.com/');
define('DOMAIN_TUAN', 'http://tuan.ec.com/');
define('DOMAIN_SHAN', 'http://shan.ec.com/');
define('DOMAIN_WWW', 'http://www.shop.com/');
define('DOMAIN_ZIXUN', 'http://zhuangxiu.ec.com/');
define('DOMAIN_SEARCH','http://localhost:80/mallsearch/');
define('DOMAIN_GJ','http://guanjia.ec.com/');
define('DOMAIN_ZX', 'http://zixun.ec.com/');
define('DOMAIN_TOOL', 'http://tools.mmall.com/');
define('DOMAIN_HUI', 'http://hui.ec.com/');
define('DOMAIN_HY','http://hangye.ec.com/');
define("DOMAIN_ZXADMIN",'http://zixunadmin.shop.com/');
define("DOMAIN_PASSPORT",'http://passport.ec.com/');
define("API_COUPON",'http://service.ec.com/coupons/api.php');
/**
 * cms的JS域名
 */
